...
This first phase focuses on clean architecture, interfaces, placeholder implementations, and basic tests. The advanced visual effects and production-grade hand foreground compositing are intentionally left for later phases.
...
The app opens the default webcam and displays the live frame. If both hands are detected, a placeholder style canvas is warped onto the strip between the left and right pinch anchors.
...
- `app/tracking`: MediaPipe hand detection, anchor extraction, and smoothing
- `app/geometry`: strip quad construction and perspective warping
...
2. Improve hand anchor robustness and temporal behavior.
